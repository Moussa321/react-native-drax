...
exports.updateHoverPosition = exports.generateRandomId = exports.extractDimensions = exports.extractPosition = exports.getRelativePosition = exports.isPointInside = exports.clipMeasurements = void 0;
...
const updateHoverPosition = (parentPos, hoverPosition, startPosition, props, scrollPosition, absoluteMeasurements) => {
    "worklet";
    if (absoluteMeasurements &&
        ...
        draggedMeasurements, lockXPosition = false, lockYPosition = false, }) => {
            /*
        ...
        const x = dragAbsolutePosition.x - scrollPosition?.value?.x
            ? startPosition.value.grab.x + scrollPosition?.value?.x
            : startPosition.value.grab.x;
        const y = dragAbsolutePosition.y - scrollPosition?.value?.y
